...
Since latent diffusion does not provide official FID reference statistics, we preprocess the datasets and compute reference files manually. The generated references are stored in the refs/ directory.
